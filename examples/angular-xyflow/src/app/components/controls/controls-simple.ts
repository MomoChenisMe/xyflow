...
@Component({
  ...
  template: `
    <div class="react-flow__controls react-flow__panel bottom left" 
         style="box-shadow: var(--xy-controls-box-shadow, var(--xy-controls-box-shadow-default)); border: 1px solid rgba(255, 255, 255, 0.25); border-radius: 4px; background-color: #fefefe; display: flex; flex-direction: column; font-size: 12px; font-weight: 600; overflow: hidden;">
      @if (showZoom()) {
        <button class="react-flow__controls-button react-flow__controls-zoomin" 
                (click)="onZoomIn.emit()"
        ...
        <button class="react-flow__controls-button react-flow__controls-zoomout" 
      ...
      @if (showFitView()) {
        <button class="react-flow__controls-button react-flow__controls-fitview" 
      ...
      @if (showInteractive()) {
        <button class="react-flow__controls-button react-flow__controls-interactive" 
