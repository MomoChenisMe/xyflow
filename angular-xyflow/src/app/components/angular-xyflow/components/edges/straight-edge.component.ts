...
export interface StraightEdgeProps {
  ...
  targetX: number;
  targetY: number;
  // 為了與其他邊緣組件保持一致性而添加（StraightEdge 不使用）
 ...
 * @Component({
 *   template: `
 *     <svg:g angular-xyflow-straight-edge
 *       [sourceX]="sourceX"
 *       [sourceY]="sourceY"
 *       [targetX]="targetX"
 *       [targetY]="targetY" />
...
export class StraightEdgeComponent {
  ...
  // sourcePosition 和 targetPosition 在 StraightEdge 中不使用，但為了相容性而定義
  ...
  // pathOptions 為了相容性而定義（StraightEdge 不使用）
