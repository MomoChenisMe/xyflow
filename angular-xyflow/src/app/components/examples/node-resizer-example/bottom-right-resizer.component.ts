...
// 專案內部模組
import { HandleComponent, NodeResizeControlComponent, ResizeControlVariant } from '../../angular-xyflow';
import type { NodeChange } from '../../angular-xyflow/types';

@Component({
  selector: 'app-bottom-right-resizer',
  standalone: true,
...
export class BottomRightResizerComponent {
